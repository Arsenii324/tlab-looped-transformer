...
def main():
    ...
    arms = [
        ("ut_ctrl_s0",     Config(state_renorm=False), make_tcfg("ut_ctrl_s0")),
        ("ut_b4_s0",       Config(state_renorm=False, kv_untie_buckets=4), make_tcfg("ut_b4_s0")),
        ("ut_b4_gate_s0",  Config(state_renorm=False, kv_untie_buckets=4,
                                  depth_gate_mode="state_norm"), make_tcfg("ut_b4_gate_s0")),
    ]
