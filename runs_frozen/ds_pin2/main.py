...
def main():
    ...
    arms = [
        ("pin_control_s0", Config(state_renorm=False), make_tcfg("pin_control_s0")),
        ("pin_lora_b2_s0", Config(state_renorm=False, cond_mode="lora_cycle", cond_lora_rank=4,
                                     cond_lora_branches=4, cond_fixed_branch=2),
         make_tcfg("pin_lora_b2_s0")),
    ]
    ...
    log("=== PIN-2 CLEAN CONTROL COMPLETED ===")
