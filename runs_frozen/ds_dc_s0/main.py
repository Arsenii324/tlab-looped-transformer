...
def main():
    ...
    arms = [
        ("dc_control_s0", Config(state_renorm=False), make_tcfg("dc_control_s0")),
        ("dc_w2_s0",      Config(state_renorm=False, kv_window=2), make_tcfg("dc_w2_s0")),
        ("dc_w3_s0",      Config(state_renorm=False, kv_window=3), make_tcfg("dc_w3_s0")),
        ("dg_norm_s0",    Config(state_renorm=False, depth_gate_mode="state_norm"), make_tcfg("dg_norm_s0")),
    ]
