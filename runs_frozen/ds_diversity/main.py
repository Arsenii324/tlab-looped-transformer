...
def main():
    ...
    arms = [
        ("dv_control_s0", Config(state_renorm=False), make_tcfg("dv_control_s0")),
        ("dv_lora_r4_s0", Config(state_renorm=False, cond_mode="lora_cycle", cond_lora_rank=4,
                                    cond_lora_branches=4), make_tcfg("dv_lora_r4_s0")),
        ("dv_lora_fixed0_s0", Config(state_renorm=False, cond_mode="lora_cycle", cond_lora_rank=4,
                                        cond_lora_branches=4, cond_fixed_branch=True),
         make_tcfg("dv_lora_fixed0_s0")),
    ]
    ...
    log("=== DIVERSITY-VS-CAPACITY CONTROL COMPLETED ===")
