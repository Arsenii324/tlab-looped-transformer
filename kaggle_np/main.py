...
def main():
    ...
    arms = [
        ("no_state_renorm_normpen", dataclasses.replace(center_model, state_renorm=False),
         TrainConfig(run_name="no_state_renorm_normpen", batch_size=8, total_tokens=90_000_000,
                      eval_every_tokens=4_000_000, norm_penalty=0.01)),
    ]
